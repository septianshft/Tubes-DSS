            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Submissions</th> {{-- Added Submissions Count --}}
                    ...
                    @forelse ($batches as $batch)
                        <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <a href="{{ route('admin.scholarship-batches.submissions', $batch) }}" wire:navigate class="hover:text-indigo-600">
                                    {{ $batch->name }}
                                </a>
                            </td>
