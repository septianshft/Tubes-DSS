<div>
    <div class="mb-6 pb-4">
        ...
        <p class="text-sm text-gray-500 mt-1">Enter the details for the new student. Required fields are marked with an asterisk (*)</p>
    </div>

    <form wire:submit.prevent="save" class="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        @error('average_score') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        @error('class_attendance_percentage') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        @error('tuition_payment_delays') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        @error('extracurricular_position') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        @error('extracurricular_activeness') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
        </div>
