<div class="space-y-6">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="border border-gray-200 rounded-lg p-4">
                ...
                <?php if(!empty($selectedStudentIds)): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <?php if($submission->rank <= 3): ?>
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        ...
                                        <?php if($rankingMode === 'academic' && $this->getTiedSubmissionsAtRank($submission->rank) > 1): ?>
                                ...
                                <?php else: ?>
                                    <span class="text-gray-900">
                                        ...
                                        <?php if($rankingMode === 'academic' && $submission->rank && $this->getTiedSubmissionsAtRank($submission->rank) > 1): ?>
    ...
    <?php endif; ?>
</div><?php /**PATH D:\Data kuiah\SMT 8\SPK\TUBES\prototype-4\resources\views\livewire\admin\results\scholarship-results.blade.php ENDPATH**/ ?>