    ...
    <div class="mt-6 overflow-x-auto bg-white shadow rounded-lg">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = ['NISN', 'Name', 'Class', 'Date of Birth', 'Address', 'Actions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\Data kuiah\SMT 8\SPK\TUBES\prototype-4\resources\views/livewire/teacher/students/list-students.blade.php ENDPATH**/ ?>