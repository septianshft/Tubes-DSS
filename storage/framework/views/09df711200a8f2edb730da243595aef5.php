                ...
                <div class="sm:col-span-6">
                    ...
                    <div class="mt-2">
                        <input type="text" wire:model.defer="name" id="name" placeholder="e.g., 2025 Spring Scholarship"
                            class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700/50 dark:text-gray-100 shadow-sm focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm <?php $__errorArgs = ['name'];
                ...
                <div class="sm:col-span-6">
                    ...
                    <div class="mt-2">
                        <textarea wire:model.defer="description" id="description" rows="4"
                            ...
                            class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700/50 dark:text-gray-100 shadow-sm focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="date" wire:model.defer="start_date" id="start_date"
                            class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700/50 dark:text-gray-100 shadow-sm focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm <?php $__errorArgs = ['start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="date" wire:model.defer="end_date" id="end_date"
                            class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700/50 dark:text-gray-100 shadow-sm focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm <?php $__errorArgs = ['end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="my-3 p-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-md text-sm text-red-700 dark:text-red-300"><?php echo e($message); ?></div> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-8">
                <?php $__currentLoopData = $criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $criterion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div wire:key="<?php echo e($criterion['component_id']); ?>" class="p-6 border rounded-lg bg-gray-50 dark:bg-gray-800/30 dark:border-gray-700 shadow-md space-y-6 relative group">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-100"><?php echo e($criterion['display_name'] ?: 'New Criterion'); ?> (Criterion <?php echo e($index + 1); ?>)</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            <div>
                                <label for="criteria_<?php echo e($index); ?>_name_key" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-200">Predefined Name <span class="text-xs text-gray-500 dark:text-gray-400">(Optional)</span></label>
                                <select wire:model.live="criteria.<?php echo e($index); ?>.name_key" id="criteria_<?php echo e($index); ?>_name_key"
                                        class="mt-2 block w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700/50 dark:text-gray-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm <?php $__errorArgs = ['criteria.'.$index.'.name_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label for="criteria_<?php echo e($index); ?>_custom_name_input" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-200">Or Custom Name</label>
                                <input type="text" wire:model.live.debounce.500ms="criteria.<?php echo e($index); ?>.custom_name_input" id="criteria_<?php echo e($index); ?>_custom_name_input"
                                       placeholder="e.g., Academic Excellence"
                                       class="mt-2 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700/50 dark:text-gray-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm <?php $__errorArgs = ['criteria.'.$index.'.custom_name_input'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       <?php echo e(!empty($criteria[$index]['name_key']) ? 'disabled bg-gray-100 dark:bg-gray-700/30 cursor-not-allowed' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4">
                            <div>
                                <label for="criteria_<?php echo e($index); ?>_weight" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-200">Weight <span class="text-xs text-gray-500 dark:text-gray-400">(0.0 to 1.0)</span></label>
                                <input type="number" step="0.01" min="0" max="1" wire:model.defer="criteria.<?php echo e($index); ?>.weight" id="criteria_<?php echo e($index); ?>_weight"
                                       placeholder="e.g., 0.25"
                                       class="mt-2 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700/50 dark:text-gray-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm <?php $__errorArgs = ['criteria.'.$index.'.weight'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label for="criteria_<?php echo e($index); ?>_type" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-200">Type</label>
                                <select wire:model.defer="criteria.<?php echo e($index); ?>.type" id="criteria_<?php echo e($index); ?>_type"
                                        class="mt-2 block w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700/50 dark:text-gray-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm <?php $__errorArgs = ['criteria.'.$index.'.type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label for="criteria_<?php echo e($index); ?>_data_type" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-200">Data Type</label>
                                <select wire:model.live="criteria.<?php echo e($index); ?>.data_type" id="criteria_<?php echo e($index); ?>_data_type"
                                        class="mt-2 block w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700/50 dark:text-gray-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm <?php $__errorArgs = ['criteria.'.$index.'.data_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($criterion['options_config_type'] === 'options'): ?>
                            <div class="mt-6 p-5 border rounded-lg bg-gray-100 dark:bg-gray-700/60 dark:border-gray-600 space-y-4 shadow">
                                <h4 class="text-base font-semibold text-gray-800 dark:text-gray-100">Define Options for "<?php echo e($criterion['display_name'] ?: 'This Criterion'); ?>"</h4>
                                <?php $__errorArgs = ['criteria.'.$index.'.options'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="my-2 p-2 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-md text-xs text-red-700 dark:text-red-300"><?php echo e($message); ?></p> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                <div class="space-y-3">
                                    <?php $__currentLoopData = $criterion['options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optIndex => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div wire:key="criterion-<?php echo e($index); ?>-option-<?php echo e($optIndex); ?>" class="grid grid-cols-1 md:grid-cols-10 gap-x-4 gap-y-2 items-center p-3 rounded-md border dark:border-gray-600/50 bg-white dark:bg-gray-700/30">
                                            <div class="md:col-span-3">
                                                <label for="criteria_<?php echo e($index); ?>_options_<?php echo e($optIndex); ?>_label" class="block text-xs font-medium text-gray-700 dark:text-gray-300">Display Label</label>
                                                <input type="text" wire:model.defer="criteria.<?php echo e($index); ?>.options.<?php echo e($optIndex); ?>.label" id="criteria_<?php echo e($index); ?>_options_<?php echo e($optIndex); ?>_label"
                                                       ...
                                                       class="mt-1 block w-full py-1.5 px-2.5 border-gray-300 dark:border-gray-500 dark:bg-gray-600/50 dark:text-gray-100 rounded-md shadow-sm sm:text-xs focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['criteria.'.$index.'.options.'.$optIndex.'.label'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="md:col-span-3">
                                                <label for="criteria_<?php echo e($index); ?>_options_<?php echo e($optIndex); ?>_value" class="block text-xs font-medium text-gray-700 dark:text-gray-300">Stored Value</label>
                                                <input type="text" wire:model.defer="criteria.<?php echo e($index); ?>.options.<?php echo e($optIndex); ?>.value" id="criteria_<?php echo e($index); ?>_options_<?php echo e($optIndex); ?>_value"
                                                       ...
                                                       class="mt-1 block w-full py-1.5 px-2.5 border-gray-300 dark:border-gray-500 dark:bg-gray-600/50 dark:text-gray-100 rounded-md shadow-sm sm:text-xs focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['criteria.'.$index.'.options.'.$optIndex.'.value'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="md:col-span-2">
                                                <label for="criteria_<?php echo e($index); ?>_options_<?php echo e($optIndex); ?>_numeric_value" class="block text-xs font-medium text-gray-700 dark:text-gray-300">Numeric Score</label>
                                                <input type="number" step="any" wire:model.defer="criteria.<?php echo e($index); ?>.options.<?php echo e($optIndex); ?>.numeric_value" id="criteria_<?php echo e($index); ?>_options_<?php echo e($optIndex); ?>_numeric_value"
                                                       placeholder="e.g., 5"
                                                       class="mt-1 block w-full py-1.5 px-2.5 border-gray-300 dark:border-gray-500 dark:bg-gray-600/50 dark:text-gray-100 rounded-md shadow-sm sm:text-xs focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['criteria.'.$index.'.options.'.$optIndex.'.numeric_value'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="md:col-span-2 flex items-end justify-end">
                                                <button type="button" wire:click="removeOption(<?php echo e($index); ?>, <?php echo e($optIndex); ?>)" title="Remove Option"
                        ...
                        <?php if($criterion['options_config_type'] === 'value_map'): ?>
                            <div class="mt-6 p-5 border rounded-lg bg-gray-100 dark:bg-gray-700/60 dark:border-gray-600 space-y-4 shadow">
                                <h4 class="text-base font-semibold text-gray-800 dark:text-gray-100">Define Text to Value Mappings for "<?php echo e($criterion['display_name'] ?: 'This Criterion'); ?>"</h4>
...
unset($__errorArgs, $__bag); ?>
                                <div class="space-y-3">
                                    <?php $__currentLoopData = $criterion['value_map']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapIndex => $mapEntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div wire:key="criterion-<?php echo e($index); ?>-valuemap-<?php echo e($mapIndex); ?>" class="grid grid-cols-1 md:grid-cols-7 gap-x-4 gap-y-2 items-center p-3 rounded-md border dark:border-gray-600/50 bg-white dark:bg-gray-700/30">
                                            <div class="md:col-span-3">
                                                <label for="criteria_<?php echo e($index); ?>_value_map_<?php echo e($mapIndex); ?>_key" class="block text-xs font-medium text-gray-700 dark:text-gray-300">Expected Text Input</label>
                                                <input type="text" wire:model.defer="criteria.<?php echo e($index); ?>.value_map.<?php echo e($mapIndex); ?>.key_input" id="criteria_<?php echo e($index); ?>_value_map_<?php echo e($mapIndex); ?>_key"
                                                       ...
                                                       class="mt-1 block w-full py-1.5 px-2.5 border-gray-300 dark:border-gray-500 dark:bg-gray-600/50 dark:text-gray-100 rounded-md shadow-sm sm:text-xs focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['criteria.'.$index.'.value_map.'.$mapIndex.'.key_input'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="md:col-span-1">
                                                <label for="criteria_<?php echo e($index); ?>_value_map_<?php echo e($mapIndex); ?>_value" class="block text-xs font-medium text-gray-700 dark:text-gray-300">Numeric Score</label>
                                                <input type="number" step="any" wire:model.defer="criteria.<?php echo e($index); ?>.value_map.<?php echo e($mapIndex); ?>.value_input" id="criteria_<?php echo e($index); ?>_value_map_<?php echo e($mapIndex); ?>_value"
                                                       placeholder="e.g., 4.0"
                                                       class="mt-1 block w-full py-1.5 px-2.5 border-gray-300 dark:border-gray-500 dark:bg-gray-600/50 dark:text-gray-100 rounded-md shadow-sm sm:text-xs focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['criteria.'.$index.'.value_map.'.$mapIndex.'.value_input'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="md:col-span-1 flex items-end justify-end">
                                                <button type="button" wire:click="removeValueMapEntry(<?php echo e($index); ?>, <?php echo e($mapIndex); ?>)" title="Remove Mapping"
                                                        class="p-2 bg-red-100 text-red-600 rounded-md hover:bg-red-200 dark:bg-red-700/50 dark:text-red-300 dark:hover:bg-red-700/80 transition-colors duration-150">
                                                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4">
                                                        <path fill-rule="evenodd" d="M5 3.25V4H2.75a.75.75 0 0 0 0 1.5h.3l.815 8.15A1.5 1.5 0 0 0 5.357 15h5.285a1.5 1.5 0 0 0 1.493-1.35l.815-8.15h.3a.75.75 0 0 0 0-1.5H11v-.75A2.25 2.25 0 0 0 8.75 1h-1.5A2.25 2.25 0 0 0 5 3.25Zm2.25-.75a.75.75 0 0 0-.75.75V4h3v-.75a.75.75 0 0 0-.75-.75h-1.5ZM6.05 6a.75.75 0 0 1 .787.713l.275 5.5a.75.75 0 0 1-1.498.075l-.275-5.5A.75.75 0 0 1 6.05 6Zm3.9 0a.75.75 0 0 1 .712.787l-.275 5.5a.75.75 0 0 1-1.498-.075l.275-5.5a.75.75 0 0 1 .786-.711Z" clip-rule="evenodd" />
                                                    </svg>
            ...
            <div class="mt-8 flex items-center justify-between">
                ...
                <div class="w-1/3">
                    <div class="flex justify-between mb-1">
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Total Weight: <?php echo e(number_format($totalWeight, 2)); ?> / 1.00</span>
                        <span class="text-sm font-medium <?php echo e($totalWeight > 1 ? 'text-red-500 dark:text-red-400' : 'text-gray-700 dark:text-gray-300'); ?>"><?php echo e(number_format($progress, 0)); ?>%</span>
                    </div>
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                        <div class="<?php echo e($progressColor); ?> h-2.5 rounded-full" style="width: <?php echo e(min($progress, 100)); ?>%"></div>
                    </div>
                     <?php if($totalWeight > 1): ?>
                        <p class="text-xs text-red-500 dark:text-red-400 mt-1">Total weight exceeds 1.0. Please adjust.</p>
                    <?php elseif($totalWeight < 1 && count($criteria) > 0): ?>
...
</div><?php /**PATH D:\Data kuiah\SMT 8\SPK\TUBES\prototype-4\resources\views\livewire\admin\scholarship-batches\create-scholarship-batch.blade.php ENDPATH**/ ?>