<div>
    ...
    <div class="grid gap-6">
        <?php $__empty_1 = true; $__currentLoopData = $batches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div wire:key="batch-<?php echo e($batch->id); ?>" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200">
                <div class="p-6">
                    <div class="flex items-start justify-between mb-4">
                        ...
                        <span class="ml-4 inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($statusClasses); ?>">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span>
                                <?php echo e(\Illuminate\Support\Carbon::parse($batch->start_date)->format('M d, Y')); ?> -
                                <?php echo e(\Illuminate\Support\Carbon::parse($batch->end_date)->format('M d, Y')); ?>

                            </span>
                        </div>

                        <div class="flex items-center space-x-3">
                            <?php if($isEffectivelyOpen): ?>
    ...
    <?php endif; ?>
</div><?php /**PATH D:\Data kuiah\SMT 8\SPK\TUBES\prototype-4\resources\views\livewire\teacher\scholarship-batches\list-open-batches.blade.php ENDPATH**/ ?>