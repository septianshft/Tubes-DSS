        ...
        <div class="p-6 space-y-6">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div class="mt-1 mb-2 min-h-[44px] p-2 border rounded-md border-gray-300 flex flex-wrap gap-2">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $this->allStudents->whereIn('id', $selectedStudentIds); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->allStudents->whereIn('id', $selectedStudentIds)->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div wire:key="student-criteria-block-<?php echo e($student->id); ?>" class="p-4 border border-gray-300 rounded-lg shadow-sm bg-white">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $criteriaConfig; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criterion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!--[if BLOCK]><![endif]--><?php if(isset($criterion['id']) && isset($criterion['name'])): ?>
                                            <?php
                                            ...
                                            <div wire:key="student-<?php echo e($studentId); ?>-criterion-<?php echo e($criterionId); ?>">
                                                <label for="<?php echo e($elementId); ?>" class="block text-sm font-medium text-gray-700">
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php if(strpos($criterion['rules'] ?? '', 'required') !== false): ?>
                                                        <span class="text-red-500 font-semibold">*</span>
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                </label>
                                                <?php $inputType = $criterion['type'] ?? 'text'; ?>

                                                <!--[if BLOCK]><![endif]--><?php if($inputType === 'select' && isset($criterion['options'])): ?>
                                                    <select wire:model.lazy="<?php echo e($wireModelPath); ?>" id="<?php echo e($elementId); ?>"
                                                        ...
                                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $criterion['options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionValue => $optionLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
