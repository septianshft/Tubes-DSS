        ...
        <div class="p-6 space-y-6">
            ...
            <div x-data="{
                ...
                <div class="mb-3 min-h-[52px] p-3 border rounded-lg border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 flex flex-wrap gap-2 items-start transition-colors duration-200">
                    ...
                    ?>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $this->allStudents->whereIn('id', $studentIdsToDisplay); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <div class="flex items-center flex-1">
                                    ...
                                    <div class="ml-3 flex-1">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if(is_array($selectedStudentIds) && in_array($student->id, $selectedStudentIds)): ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div class="px-4 py-8 text-center">
                                ...
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                    <!--[if BLOCK]><![endif]--><?php if(!empty($studentSearch)): ?>
                ...
                <!-- Error Messages -->
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selectedStudentIds'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <!--[if BLOCK]><![endif]--><?php if(empty($criteriaConfig)): ?>
                ...
                <?php else: ?>
                    <div class="space-y-10"> 
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->allStudents->whereIn('id', $selectedStudentIds)->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-6 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg bg-gray-50 dark:bg-slate-800 mb-8 transition-all hover:shadow-xl">
                                ...
                                <div class="space-y-6">
                                    ...
                                    ?>
                                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $criteriaConfig; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criterion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($criterionId && $wireModelPath): ?>
                                            <div class="grid grid-cols-1 gap-y-2">
                                                <label for="<?php echo e($inputFieldId); ?>" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php if($criterion['is_required'] ?? false): ?> <span class="text-red-500 dark:text-red-400 font-semibold">*</span> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                </label>

                                                <!--[if BLOCK]><![endif]--><?php if(isset($criterion['description'])): ?>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5 mb-1"><?php echo e($criterion['description']); ?></p>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                                                <!--[if BLOCK]><![endif]--><?php switch($criterion['data_type'] ?? 'text'):
                                                    case ('numeric'): ?>
...
unset($__errorArgs, $__bag); ?>">
                                                    ...
                                                    <?php case ('qualitative_option'): ?>
                                                        <!--[if BLOCK]><![endif]--><?php if(!empty($criterion['options']) && is_array($criterion['options'])): ?>
...
unset($__errorArgs, $__bag); ?>">
                                                                ...
                                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $criterion['options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                                        ...
                                                        ?>
                                                        <!--[if BLOCK]><![endif]--><?php if(!is_null($existingFileValue) && ($existingFileValue instanceof \Livewire\Features\SupportFileUploads\TemporaryUploadedFile || (is_string($existingFileValue) && !empty($existingFileValue)))): ?>
                                                            <div class="mt-1.5 text-xs text-gray-600 dark:text-gray-400 flex items-center">
                                                                ...
                                                                <!--[if BLOCK]><![endif]--><?php if($existingFileValue instanceof \Livewire\Features\SupportFileUploads\TemporaryUploadedFile && method_exists($existingFileValue, 'getClientOriginalName')): ?>
                                                                    <span>Selected: <?php echo e($existingFileValue->getClientOriginalName()); ?></span>
                                                                    <!--[if BLOCK]><![endif]--><?php if(method_exists($existingFileValue, 'getSize')): ?>
...
unset($__errorArgs, $__bag); ?>">
                                                    ...
                                                    <?php default: ?> 
                                                        <!--[if BLOCK]><![endif]--><?php if(isset($criterion['multiline']) && $criterion['multiline']): ?>
...
unset($__errorArgs, $__bag); ?>">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = [$wireModelPath];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <?php else: ?>
                                            <!--[if BLOCK]><![endif]--><?php if(!$criterionId): ?>
...
<?php /**PATH D:\Data kuiah\SMT 8\SPK\TUBES\prototype-4\resources\views/livewire/teacher/submissions/create-student-submission-for-batch.blade.php ENDPATH**/ ?>