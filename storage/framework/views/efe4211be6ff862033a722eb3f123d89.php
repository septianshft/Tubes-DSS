<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        ...
        <div class="lg:col-span-2 bg-white shadow-lg rounded-xl p-6 hover:shadow-xl transition-shadow duration-300 ease-in-out">
            ...
            <!--[if BLOCK]><![endif]--><?php if($upcomingBatches && $upcomingBatches->count() > 0): ?>
                <ul class="space-y-3">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $upcomingBatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">
                                        Status: <span class="font-medium <?php if($batch->status == 'open'): ?> text-green-600 <?php else: ?> text-yellow-600 <?php endif; ?>"><?php echo e(Str::title($batch->status)); ?></span>
                                    </p>
                                </div>
                                <div class="text-right">
                                    <!--[if BLOCK]><![endif]--><?php if($batch->end_date): ?>
    ...
    <div class="bg-white shadow-lg rounded-xl p-6 hover:shadow-xl transition-shadow duration-300 ease-in-out">
        ...
        <!--[if BLOCK]><![endif]--><?php if($recentSubmissions && $recentSubmissions->count() > 0): ?>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentSubmissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\Data kuiah\SMT 8\SPK\TUBES\prototype-4\resources\views/livewire/teacher/dashboard.blade.php ENDPATH**/ ?>