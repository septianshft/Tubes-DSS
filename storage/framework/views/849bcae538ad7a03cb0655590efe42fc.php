<div>
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <?php if(count($selectedBatches) > 0): ?>
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider cursor-pointer hover:bg-gray-200"
                            ...
                            <div class="flex items-center justify-center">
                                Submissions
                                <?php if($sortBy === 'submissions_count'): ?>
                                    <?php if($sortDirection === 'asc'): ?>
                                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"></path>
                                        </svg>
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <?php if($batch->status !== 'active' && !$isClosed): ?>
    ...
    <?php if($confirmingActivateBatch): ?>
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white p-6 rounded-lg shadow-xl max-w-sm mx-auto">
                <div class="flex items-center mb-4">
                    <div class="flex-shrink-0">
...
</div><?php /**PATH D:\Data kuiah\SMT 8\SPK\TUBES\prototype-4\resources\views\livewire\admin\scholarship-batches\list-scholarship-batches.blade.php ENDPATH**/ ?>