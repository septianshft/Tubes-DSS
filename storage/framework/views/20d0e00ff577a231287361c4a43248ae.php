...
<div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
                            ...
                            <p><strong class="dark:text-gray-400">Status:</strong> <span class="px-2 py-1 text-xs font-semibold rounded-full
                                ...
                                <?php endswitch; ?>
                            "><?php echo e(ucwords(str_replace('_', ' ', $submission->status))); ?></span></p>
                            <!--[if BLOCK]><![endif]--><?php if($submission->revision_notes): ?>
                                <p><strong class="dark:text-gray-400">Revision Notes:</strong> <?php echo e($submission->revision_notes); ?></p>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if($submission->status_updated_by): ?>
                                <p><strong class="dark:text-gray-400">Last Updated By:</strong> <?php echo e($submission->statusUpdatedBy->name ?? 'Unknown'); ?>

                                <!--[if BLOCK]><![endif]--><?php if($submission->status_updated_at): ?>
                    ...
                    <div class="mb-8">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(!empty($criteriaDetails)): ?>
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $criteriaDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criterionId => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php if(isset($details['file_path']) && $details['file_path']): ?>
                                                        <a href="<?php echo e(url('storage/' . $details['file_path'])); ?>" target="_blank" class="ml-2 text-blue-500 hover:text-blue-700">(View File)</a>
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                                    
                                                    <!--[if BLOCK]><![endif]--><?php if(isset($details['normalizedScore']) && is_numeric($details['normalizedScore'])): ?>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300"><?php echo e(ucfirst($details['type'] ?? 'N/A')); ?></td>
                                            </tr>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(!empty($sawCalculationSteps) && isset($sawCalculationSteps['steps'])): ?>
                        <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="space-y-6">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $sawCalculationSteps['steps']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg shadow">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if(isset($step['error'])): ?>
                                        ...
                                        <?php else: ?>
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2 text-sm">
                                                ...
                                                <p><strong class="dark:text-gray-400">Numeric Value:</strong> <?php echo e($step['numeric_value_for_calc'] ?? $step['numeric_value'] ?? 'N/A'); ?></p>
                                                ...
                                                <p><strong class="dark:text-gray-400">Criterion Type:</strong> <?php echo e(ucfirst($step['criterion_type'] ?? 'N/A')); ?></p>
                                                ...
                                                <p><strong class="dark:text-gray-400">Normalized Value:</strong> <?php echo e(number_format($step['normalized_value_after_clamping'] ?? 0, 6)); ?></p>
                    ...
                    <?php if(!empty($sawCalculationSteps) && isset($sawCalculationSteps['summary'])): ?>
                        <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg shadow text-sm space-y-2">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(isset($sawCalculationSteps['summary']['tie_breaking_factor_added'])): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(isset($sawCalculationSteps['summary']['notes'])): ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($submission->status !== 'approved' && $submission->status !== 'rejected'): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showRevisionModal): ?>
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['revisionNotes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH D:\Data kuiah\SMT 8\SPK\TUBES\prototype-4\resources\views/livewire/admin/submissions/show-submission.blade.php ENDPATH**/ ?>