<div>
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2">
        ...
        <div class="p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <?php if($closedBatches->count() > 0): ?>
                <ul class="space-y-2">
                    <?php $__currentLoopData = $closedBatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-md">
                            <div>
                                <p class="font-medium text-gray-800 dark:text-gray-100"><?php echo e($batch->name); ?></p>
                                <p class="text-sm text-gray-500 dark:text-gray-400">
...
</div><?php /**PATH D:\Data kuiah\SMT 8\SPK\TUBES\prototype-4\resources\views\livewire\admin\dashboard.blade.php ENDPATH**/ ?>